...
# Enable installed plugins (Diode voor Discovery, Validity voor compliance)
PLUGINS = [
    'netbox_diode_plugin',
    'validity',
]

# Plugin configuration (Diode)
# Secrets worden door provisioning in env/netbox.generated.env gezet.
PLUGINS_CONFIG = {
    'netbox_diode_plugin': {
        'diode_target_override': environ.get('DIODE_TARGET_OVERRIDE', 'grpc://172.17.0.1:8080/diode'),
